package Koha::Plugin::Fi::KohaSuomi::GeneratePin;
...
our $metadata = {
    ...
    author          => 'Lari Strand',
    date_authored   => '2024-09-24',
    date_updated    => '2024-09-24',
    minimum_version => '23.11',
    maximum_version => '',
    version         => $VERSION,
    description     => "Luo määritetyille asiakastyypeille nelinumeroiset PIN-koodit salasanaksi",
};
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/GeneratePin/";
